<template>
  <div class="table-container">
    ...
    <el-table
      ...
      :height="height"
    >
      <el-table-column show-overflow-tooltip prop="Value" label="选项标识"></el-table-column>
    ...
    <el-dialog title="新增子级" :visible.sync="dialogFormVisible" width="500px" @close="close">
  ...
  export default {
    data() {
      return {
        ...
        addRules: {
          Value: [{ required: true, trigger: 'blur', message: '请输入子级标识' }],
          Name: [{ required: true, trigger: 'blur', message: '请输入子级名称' }],
        }
      }
    },
    computed: {
