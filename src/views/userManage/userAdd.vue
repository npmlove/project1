...
<script>
  ...
  import { getUpdateUser, getCompanyOrgList, getUserDetails } from '@/api/user'
  export default {
    name: 'Form',
    data() {
      return {
    ...
    methods: {
      ...
      async initGetUserDetails() {
        ...
        const { Data, Count } = await getUserDetails(params)
      ...
      async submitForm(formName) {
        this.$refs[formName].validate(async (valid) => {
          if (valid) {
            this.ruleForm.UserID = this.getGuid()
