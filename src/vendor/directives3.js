  ...
  bind(el, binding, vnode, oldVnode) {
    ...
    resizeEl.onmousedown = (e) => {
      ...
      document.onmousemove = function (e) {
        ...
        // 经过事件委托，计算移动的距离
        let x = e.clientX - disX + (e.clientX - clientX);//这里 因为elementUI的dialog控制居中的，因此水平拉伸效果是双倍
...
/**
 *  注意：若是是el-dialog弹出的表单el-form，最好不要把提交按钮当作el-form-item（elementUI文档是这么用的），放在el-dialog里。
 *  否则按钮会同el-dialog中标签同样被overflow；
*/