...
const mutations = {
  ...
  delVisitedRoute(state, route) {
    if(route.path == '/deviceManage/otadetail'){  //OTA文件详情页面，数据缓存
      sessionStorage.removeItem("otadetail");
    } else if (route.path == '/deviceManage/deviceDataPoint'){ //设备类型详情页面，数据缓存
      sessionStorage.removeItem("deviceTypeDetail");
    }
