<template>
  <div class="contont" v-if="isDataDone">
      ...
      <div v-if="initData.status == 25">
        ...
        <el-button type="primary" class="setWidth" @click="exdeOrder(1)">卡口放行</el-button>
      ...
      <div v-if="initData.status == 27">
        ...
        <el-button type="" disabled class="setWidth"   >{{initData.statusDesc}}</el-button>
        <el-button type="primary" @click="saveOrder" >保存</el-button>
        <el-button type="primary" class="setWidth" @click="exdeOrder(1)" >查验正常</el-button>
        <el-button type="danger" @click="exdeOrder(2)" >查验异常，待处理</el-button>
      </div>
      <div v-if="initData.status == 29">
        <el-button type="" disabled class="setWidth"   >{{initData.statusDesc}}</el-button>
        <el-button type="primary" @click="saveOrder" >保存</el-button>
        <el-button type="primary" class="setWidth" @click="exdeOrder(1)" >处理成功</el-button>
        <el-button type="danger" @click="exdeOrder(2)" >查验处理失败，取消订单</el-button>  
        <!-- 安检异常，待处理 -->
      </div>
      ...
      <div v-if="initData.status == 33">
        ...
        <el-button type="primary" @click="saveOrder" >保存</el-button>
        <el-button type="primary" class="setWidth" @click="exdeOrder(1)" >安检通过</el-button>
        <el-button type="danger" @click="exdeOrder(2)" >处理失败，取消订单</el-button>
      </div>
      <div class="common">
          <div>
            <span>订单号</span>
