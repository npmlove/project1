      ...
      <el-form :label-position="labelPosition" :inline="true" label-width="150px" size="medium" class="demo-form-inline">
        ...
        <div>
          <el-form-item required label="件数">
            <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="inboundPiece" onkeyup="value=value.replace(/[^\d]/g, '')" maxlength="9" placeholder="请输入件数" style="width: 216px;">
              <template slot="append">PCS</template>
            </el-input>
          </el-form-item>
          <el-form-item required label="体积">
            <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="inboundCbm" @blur="cbmBlur(inboundCbm,0,'体积1')" onkeyup="value=value.replace(/[^\d\.]/g, '')" maxlength="9" placeholder="请输入体积" style="width: 216px;">
        ...
        <div>
          <el-form-item required label="重量">
            <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="inboundWeight" onkeyup="value=value.replace(/[^\d]/g, '')" maxlength="6" placeholder="请输入重量" style="width: 216px;">
          ...
          <div class="flight-template" style="width: auto;margin-left: 0;">
            ...
            <div v-for="(childerItem,childerIndex) in orderCargoDetailList" :key="childerIndex" class="flight-template-ul-content">
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.piece" onkeyup="value=value.replace(/[^\d]/g, '')" maxlength="9" size="small" style="width: 90%;"></el-input>
              </div>
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.cbm"  @blur="cbmBlur(childerItem.cbm,childerIndex,'体积2')" onkeyup="value=value.replace(/[^\d\.]/g, '')" maxlength="9" size="small" style="width: 90%;"></el-input>
              </div>
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.weight" onkeyup="value=value.replace(/[^\d]/g, '')" maxlength="6" size="small" style="width: 90%;"></el-input>
              </div>
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-input :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.cargoSize" onkeyup="value=value.replace(/[^\d]/g, '')" maxlength="3" size="small" style="width: 90%;"></el-input>
              </div>
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-select :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.packing" size="small" clearable placeholder="请选择" style="width: 90%;">
                  <el-option
              ...
              <div class="flight-template-li" style="flex: 0 0 15%;">
                <el-select :disabled="orderStatus.indexOf(status) > -1 ? false : true" v-model="childerItem.outerBox" size="small" clearable placeholder="请选择" style="width: 90%;">
                  <el-option
              ...
              <div v-if="orderStatus.indexOf(status) > -1" class="flight-template-li" size="small" style="flex: 0 0 10%;">
                ...
                <a @click="delOrderCargoDetailList(childerIndex)" style="font-size: 18px;"><i class="el-icon-delete"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="flight-template" style="width: auto;margin-left: 0;">
            ...
            <div v-for="(childerItem,childerIndex) in arOrderPriceList" :key="childerIndex" class="flight-template-ul-content">
              ...
              <div v-if="orderStatus.indexOf(status) > -1" class="flight-template-li" size="small" style="flex: 0 0 10%;">
                ...
                <a @click="delArOrderPriceList(childerIndex)" :style="{visibility: arOrderPriceList.length == 1 ? 'hidden' : 'visible'}" style="font-size: 18px;"><i class="el-icon-delete"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="flight-template" style="width: auto;margin-left: 0;">
            ...
            <div v-for="(childerItem,childerIndex) in apOrderPriceList" :key="childerIndex" class="flight-template-ul-content">
              ...
              <div v-if="orderStatus.indexOf(status) > -1" class="flight-template-li" size="small" style="flex: 0 0 10%;">
                ...
                <a @click="delApOrderPriceList(childerIndex)" :style="{visibility: apOrderPriceList.length == 1 ? 'hidden' : 'visible'}" style="font-size: 18px;"><i class="el-icon-delete"></i></a>
              </div>
            </div>
          </div>
          <div style="margin-top: 20px;">
