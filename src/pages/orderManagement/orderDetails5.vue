      ...
      <el-form :label-position="labelPosition" :inline="true" label-width="150px" size="medium" class="demo-form-inline">
        <div class="rest-style" style="padding-left: 20px;">
          <el-form-item label=" " label-width="150px">
            ...
            <el-button @click="submitClick('失败')" style="height: 36px;line-height: 36px;padding: 0;" type="primary" >起运异常</el-button>
            <el-button @click="submitClick('通过')" style="height: 36px;line-height: 36px;padding: 0 20px;width: auto;" type="primary" >已起运</el-button>
          </el-form-item>
        </div>
      </el-form>
    </div>
