          ...
          <el-form ref="form" :model="theme" label-position="top">
            <el-form-item label="主题">
              <el-radio-group v-model="theme.name">
               ...
               <el-radio-button label="glory">自然清新</el-radio-button>
               <el-radio-button label="themeFour">梦之悠蓝</el-radio-button>
               <el-radio-button label="red">红火热情</el-radio-button>
               <el-radio-button label="grey">忧之暗灰</el-radio-button>
...
<style lang="scss" scoped>
  // @mixin vue-admin-beautiful-theme-green {
  //   color: $background-color-theme1;
  // }
  // .vue-admin-beautiful-theme-green {
  //   @include vue-admin-beautiful-theme-green;
  // }
  @mixin right-bar {
    position: fixed;
    right: 0;
